...
// document.getElementById('bulletinsDashboard').addEventListener('click', function () {
...
//       var obj = reqObj;
//       obj['status'] = _document.getElementById('btnTaskStatus').innerText;
//       _document.querySelector('#btnStatus_' + reqObj.id).innerText = _document.getElementById('btnTaskStatus').innerText;
...
//   document.querySelector('#btnStatus_' + obj.id).innerText = obj.status;
...
//       _document.getElementById('changeStatus').value = data.status_id;
//       _document.getElementById('btnStatus').innerText = data.status;
//     }
//   });
// };
